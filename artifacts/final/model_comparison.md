...
Notes: GPT and DeepSeek 6/6 after assertion-aware harness regrades on **stored replies** (`fake_policy` negations; `account_specific` user redirects)—not model-behavior changes. SAH remains 0.255.
